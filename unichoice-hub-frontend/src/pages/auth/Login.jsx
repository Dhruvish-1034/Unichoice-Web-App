    ...
    <div>
      ...
      <FormikProvider value={formik}>
        <div className="flex h-[calc(100vh_-_64px)]">
          {/* left section */}
          <div className="hidden w-6/12 lg:flex justify-center items-center bg-slate-700">
            <div>
              <p className="text-[24px]">Discover top ranked universities!</p>
              <div className="flex my-6">
                <FaGlobeAmericas className="text-[42px] my-1 mr-4" />
                <div>
              ...
              <div className="flex my-6">
                <GiSpellBook className="text-[42px] my-1 mr-4" />
                <div>
                  <p className="font-bold">
                    144567
                    <span className="block leading-4 font-normal">
              ...
              <div className="flex my-6">
                <SlCalender className="text-[42px] my-1 mr-4" />
                <div>
                  <p className="font-bold">
                    150+
                    <span className="block leading-4 font-normal">
              ...
              <div className="flex my-6">
                <CiMap className="text-[42px] my-1 mr-4" />
                <div>
                  <p className="font-bold">
                    9000+
